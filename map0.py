...
def cube(p1, p2):
    brushdef_preamble()
    plane([ p1[0], p1[1], p1[2] ], [ p2[0], p1[1], p2[2] ], [ p2[0], p1[1], p1[2] ])
    plane([ p2[0], p1[1], p1[2] ], [ p2[0], p2[1], p2[2] ], [ p2[0], p2[1], p1[2] ])
    plane([ p2[0], p2[1], p1[2] ], [ p1[0], p2[1], p2[2] ], [ p1[0], p2[1], p1[2] ])
    plane([ p1[0], p2[1], p1[2] ], [ p1[0], p1[1], p2[2] ], [ p1[0], p1[1], p1[2] ])
    plane([ p1[0], p1[1], p2[2] ], [ p2[0], p2[1], p2[2] ], [ p2[0], p1[1], p2[2] ])
    plane([ p1[0], p1[1], p1[2] ], [ p2[0], p2[1], p1[2] ], [ p1[0], p2[1], p1[2] ])
    brushdef_finish()
...
def triangle_column(p1, p2, p3):
    brushdef_preamble()
    plane(p1, p3, [p3[0], p3[1], 0])
    plane(p3, p2, [p2[0], p2[1], 0])
    plane(p2, p1, [p1[0], p1[1], 0])
    plane(p1, p2, p3)
    plane([ p1[0], p1[1], 0],[ p3[0], p3[1], 0], [ p2[0], p2[1], 0]) 
    brushdef_finish()
